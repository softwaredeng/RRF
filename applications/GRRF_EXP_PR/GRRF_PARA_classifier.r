...
timeStamp=paste("GRRF_Classifier","_rep",nRep,"_ntree",ntree,"_",timeStamp, ".RData",sep="");
...
all = cbind(err,fN)
rownames(all)=colN
pathOut=paste(getwd(), "/result/","Rep",nRep,"GRRF_Classifier",sep="");
